...
def is_mel(name, email):
    ...
    >>> is_mel("Mel Melitpolski", "lala")
    True
    >>> is_mel("Mama", "mel@ubermelon.com")
    True
    >>> is_mel("Mama", "lala")
    False
...
def most_and_least_common_type(treats):
    ...
    Test for clear winners for most and for least
    >>> treats = [
    ... {'type': 'appetizer'},
    ... {'type': 'dessert'},
    ... {'type': 'appetizer'},
    ...
    Test for sad, sad party
    >>> treats = []
    >>> most_and_least_common_type(treats)
    (None, None)

    Test for tie for least
    >>> treats = [
    ... {'type': 'appetizer'},
    ... {'type': 'dessert'},
    ... {'type': 'drink'},
    ...
    Test for just one thing brought
